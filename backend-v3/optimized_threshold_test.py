#!/usr/bin/env python3
"""
Optimized Threshold Optimization Test
Tests different similarity thresholds with better timeout handling and progress feedback.
"""
import os
import json
import time
...
class OptimizedThresholdOptimizer:
    def __init__(self):
        self.test_videos = [
            ("content/uploads/naani.mp4", ["person", "car"]),  # Simplified prompts
            ("content/uploads/road traffic.mp4", ["car", "person"])
        ]
    ...
    def test_video_analysis(self, video_path: str, prompts: str, threshold: float) -> Dict:
        ...
        try:
            with open(video_path, 'rb') as f:
                ...
                print("⏳ Starting analysis (120s timeout)...")
    ...
    def run_threshold_tests(self) -> None:
        ...
        print("🧪 OPTIMIZED THRESHOLD OPTIMIZATION TEST")
        print("=" * 60)
    ...
    def generate_report(self) -> None:
        ...
        print(f"\n💾 Detailed results saved to: optimized_threshold_results.json")

def main():
    """Main test function"""
    optimizer = OptimizedThresholdOptimizer()
    
    try:
        optimizer.run_threshold_tests()
        optimizer.generate_report()
        
        print(f"\n🎉 Optimized threshold optimization test completed!")
